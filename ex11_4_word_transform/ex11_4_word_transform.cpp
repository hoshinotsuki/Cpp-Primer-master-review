// ex11_4_word_transform.cpp : �������̨Ӧ�ó������ڵ㡣
//


//cmd:D:\\codes\\Cpp - Primer - master - review\\Cpp - Primer - master - review\\Debug\\ex11_4_word_transform.exe D : \\codes\\Cpp - Primer - master - review\\VisualStudio2012\\11\\data\\rules D : \\codes\\Cpp - Primer - master - review\\VisualStudio2012\\11\\data\\text
#include "stdafx.h"
...
map<string, string> buildMap(ifstream &map_file)
{
	...
	while (map_file >> key && getline(map_file, value))
		if (value.size() > 1) // check that there is a transformation
			trans_map[key] = value.substr(1); //����getlineÿ�ν��ܵĶ�����һ������ֹ��������ȥ���ո�
		else
			throw runtime_error("no rule for " + key);//���keyû��value��throw �쳣
	return trans_map;
}
...
{
	auto trans_map = buildMap(map_file); // ����ӳ��� map<string, string>

										 // for debugging purposes print the map after its built
	cout << "Here is our transformation map: \n\n";
	for (auto &entry : trans_map)//ȡ��ַ
